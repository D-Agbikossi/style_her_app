...
class ChatScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final msgs = [
      ...
      {'me': false, 'text': 'How was your Hair Styling Course Like? 😊', 'time': '12:45'},
      {'me': true, 'text': 'Hi, Morning too Ronald', 'time': '15:29'},
      {'me': true, 'text': 'Hello, I also just finished practicing my styling skills.', 'time': '15:52'},
    ...
    return Scaffold(
      ...
      body: Column(children: [
        Container(
          ...
          child: const Text('Today', style: TextStyle(color: AppTheme.softText)),
        ),
        Expanded(
          child: ListView.builder(
            ...
            itemBuilder: (_, i){
              final m = msgs[i];
              return ChatBubble(text: m['text'] as String, isMe: m['me'] as bool, time: m['time'] as String);
            },
          ),
        ),
        _inputBar()
      ...
      child: Container(
        ...
        child: Row(children: [
          Expanded(child: Container(
            ...
            decoration: BoxDecoration(color: AppTheme.accent, borderRadius: BorderRadius.circular(24)),
            child: const TextField(decoration: InputDecoration(border: InputBorder.none, hintText: 'Message')),
          )),
