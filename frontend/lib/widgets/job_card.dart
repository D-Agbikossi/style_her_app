    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: [
          ...
          Text(location, style: const TextStyle(color: AppTheme.softText)),
          const SizedBox(width: 12),
          const Icon(Icons.attach_money, size: 16, color: AppTheme.softText),
          const SizedBox(width: 4),
          Text(salary, style: const TextStyle(color: AppTheme.softText)),
          const SizedBox(width: 12),
          const Icon(Icons.schedule, size: 16, color: AppTheme.softText),
          const SizedBox(width: 4),
          Text(date, style: const TextStyle(color: AppTheme.softText)),
        ]),
